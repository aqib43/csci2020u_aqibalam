...
public class Controller {
    ...
    public void initialize() {
        ...
        drawBarG(Controller.avgHousingPricesByYear, Controller.avgCommercialPricesByYear, 800, 300);
        drawPieG(Controller.purchasesByAgeGroup, Controller.pieColours, 800);
    }



    public void drawPieG(int[] purchases, Color[] colors, int w) {
    ...
    public void drawBarG(double[] housingData, double[] commercialData, int w, int h) {
