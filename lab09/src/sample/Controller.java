...
public class Controller {
    ...
    private void plotL(ArrayList<Double> tickerPrices) {
    ...
    private void drawLPlot(ArrayList<Double> firstTickerPrices, ArrayList<Double> secondTickerPrices) {
        // draw axis
        ...
        plotL(firstTickerPrices);
        // draw second ticker prices
        gc.setStroke(Color.RED);
        plotL(secondTickerPrices);
    }
}
